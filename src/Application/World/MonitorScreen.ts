...
export default class MonitorScreen extends EventEmitter {
    ...
    createIframe() {
        ...
        // PROD - DigitiNexus OS (English)
        iframe.src = 'https://os.digitinexus.com/en';
        /**
     ...
     */
    createTextureLayers() {
        // Effects based on textures in static/textures/monitor are disabled.
        // Skip adding smudges, inner shadow and video static layers.
        return 0; // no depth offset
    }
